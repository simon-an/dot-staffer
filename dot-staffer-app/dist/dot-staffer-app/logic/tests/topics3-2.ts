...
describe('3 topics magic', () => {
  ...
  it('magic function 3 topics', () => {
    ...
    expect(discussions[0].discussers.map(v => (isVote(v) ? v.person : v))).to.contain('Simon P.');
    ...
    expect(discussions[1].discussers.map(v => (isVote(v) ? v.person : v))).to.contain('Minh N.');
    ...
    expect(discussions[2].discussers.map(v => (isVote(v) ? v.person : v))).to.contain('Michael W.');
